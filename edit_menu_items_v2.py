...
# -*- coding: utf-8 -*-
"""
edit_menu_items_v2.py — Tkinter editor for script_menu.db/menu_items
────────────────────────────────────────────────────────────────────
Enhancements:
  • Adds multiline "Description" field (stored in 'description' column)
  • Title bar now shows program name dynamically
  • Fully backward compatible with menu_launcherV2.py
"""
...
class MenuItemEditor(tk.Tk):
    ...
    def save(self):
        ...
        if not self._validate(rec): return
