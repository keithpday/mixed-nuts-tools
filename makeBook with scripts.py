...
def makeBook(setId, todaysDate, srcDir, destDir, zzSetId):
    if zzSetId == "None":
        bookName = destDir + "/" + setId + " Book With Scripts." + todaysDate + ".pdf"
    else:
        bookName = destDir + "/" + zzSetId + " Book With Scripts." + todaysDate + ".pdf"
...
def main():
    print("What is the Set Id? (leave 'With Scripts' off ", end="")
    setId = input()
    zzSetId = 'None'
    print("What is the ZZ Set Id? If None type 'None' (leave 'With Scripts' off ", end="")
    zzSetId = input()
    ...
    booksDir = 'C:/Users/keith/OneDrive/Documents/GitHub/MixedNutsLib/Books With Scripts'
