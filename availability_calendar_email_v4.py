...
# -*- coding: utf-8 -*-
"""
availability_calendar_email_v4.py
───────────────────────────────────────────────────────────────────────────────
...
def main():
    print("Mixed Nuts Availability Calendar Emailer (v4)")
    print("-------------------------------------------")
    ...
    # --------------------------------------------------------
    # SUBJECT LINE — Format dates as MM/DD/YYYY
    # --------------------------------------------------------
    start_str = start.strftime("%m/%d/%Y")
    end_str   = end.strftime("%m/%d/%Y")
    subject = f"Mixed Nuts Availability: {start_str} to {end_str}"
...
<p>Below is our availability for the date range you requested. Each time range shown
is long enough to accommodate a <strong>{gig_hours}-hour</strong> show at your community.
These windows already include our standard travel and equipment setup buffers,
based on where our other shows are scheduled, so any time you choose within a
listed window works fine.</p>
